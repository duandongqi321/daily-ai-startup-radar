...
description: Create a daily AI startup intelligence briefing with current research, beginner-friendly analysis, scoring, and a configurable Personal Lens.
metadata:
  short-description: Daily AI startup intelligence radar
---
...
5. Read [references/scoring_rubric.md](references/scoring_rubric.md), score candidates, and select the most useful set for the user. A normal daily briefing should cover 5-7 companies, with geography balanced when evidence allows.
6. Read [references/output_templates.md](references/output_templates.md) and write the briefing in the user's preferred language. Include source links for each company.
...
- Include company type, business model, customer, founder/team signal, strengths, market potential, risks, Personal Lens, score, and confidence.
...
- Keep daily outputs scannable. Put the highest-signal takeaways before long company notes.
